...
import {SORT_ASC} from 'admin-on-rest/lib/reducer/admin/resource/list/queryReducer';
...
export default (apiUrl, httpClient = fetchUtils.fetchJson) => {
    ...
    const convertHTTPResponseToREST = (response, type, resource, params) => {
        ...
        case GET_LIST:
            ...
            if (json.meta['record-count']===undefined) {
                throw new Error(
                    'The Record-Count is missing in the meta of the HTTP Response. The JSONAPI REST client expects responses for lists of resources to contain this meta with the total number of results to build the pagination.'
                );
            }            
